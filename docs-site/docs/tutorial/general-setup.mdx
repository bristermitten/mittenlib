...
MittenLib is a highly modular library. Its core is built around **Guice** to encourage scalable, injection-based architectures for your Spigot plugins.
...
Once the injector is created, you can write clean, testable classes that request their dependencies via the constructor using `@Inject`. MittenLib has automatically bound common Spigot types for you.
