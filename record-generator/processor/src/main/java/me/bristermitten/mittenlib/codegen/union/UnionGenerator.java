...
public class UnionGenerator {
    ...
    private static void addSealingConstructor(TypeSpec.Builder typeSpecBuilder) {
        typeSpecBuilder.addMethod(
                MethodSpec.constructorBuilder()
                        ...
                        .addCode(
                                typeSpecBuilder.typeSpecs.stream()
    ...
    private static void generateAsMethod(
    ...
    public JavaFile generate(UnionSpec unionSpec) {
        ...
        typeSpecBuilder.addAnnotation(
                AnnotationSpec.builder(GeneratedUnion.class)
        ...
        for (var toGenerate : resolved.constructors()) {
            ...
            var constructorTypeSpecBuilder =
                    generatedRecord.typeSpecBuilder().addModifiers(PUBLIC, STATIC, FINAL);

            constructorTypeSpecBuilder.superclass(recordImplName);

            RecordGenerator.addFactoryMethod(
                    toGenerate.constructor(), toGenerate.name(), typeSpecBuilder);
        ...
        return JavaFile.builder(recordImplName.packageName(), typeSpecBuilder.build()).build();
    }
}
