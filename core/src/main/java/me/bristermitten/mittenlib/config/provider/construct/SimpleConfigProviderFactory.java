...
public class SimpleConfigProviderFactory implements ConfigProviderFactory {
    ...
    @Inject
    public SimpleConfigProviderFactory(ConfigReader reader, ConfigWriter saver, ConfigInitializationStrategy initializationStrategy, ConfigPathResolver pathResolver, ObjectWriter objectWriter) {
        this.reader = reader;
        this.saver = saver;
