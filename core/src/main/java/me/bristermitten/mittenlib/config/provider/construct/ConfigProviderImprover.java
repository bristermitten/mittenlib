 ...
 * This could include caching, auto reloading, etc. The exact functionality is up to the implementation.
 */
public interface ConfigProviderImprover {
    /**
     * Improve a {@link ConfigProvider} by wrapping it with (possible) extra functionality.
     * This method should be pure and idempotent where possible.
