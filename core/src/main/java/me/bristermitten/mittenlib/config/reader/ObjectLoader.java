...
public interface ObjectLoader {
    /**
     * Loads an object from the given {@link Path}. Implementations may want to provide a more
    ...
    /**
     * Loads an object from the given source. This method should not close the given {@link Reader},
     * but may exhaust it.
     *
     * @param source the source to load from
     * @return the loaded object
