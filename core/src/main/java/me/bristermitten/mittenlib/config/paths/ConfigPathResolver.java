...
public interface ConfigPathResolver {
     ...
     * @return the resolved path, or an error if the file name could not be resolved. Note that this
     *     may return a successful result with a path that does not exist. The failure case is
     *     specifically for error states.
     */
