...
public class Configuration<T> {
    ...
    /**
     * Get the concrete implementation type of this configuration. This may be the same as {@link
     * #getType()}, but if the configuration was generated by the annotation processor, it will be the
     * actual generated implementation class, as opposed to {@link #getType()} which is the original
     * DTO type.
     */
