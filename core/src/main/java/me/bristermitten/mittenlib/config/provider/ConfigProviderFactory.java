...
public class ConfigProviderFactory {
    ...
    @Inject
    public ConfigProviderFactory(ConfigReader reader, FileWatcherService service, ConfigInitializationStrategy initializationStrategy, ConfigPathResolver pathResolver) {
        this.reader = reader;
    ...
    public <T> ConfigProvider<T> createProvider(Configuration<T> configuration) {
