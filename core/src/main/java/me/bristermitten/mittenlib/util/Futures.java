...
public class Futures {
     ...
     * holding a <code>Collection&lt;T&gt;</code> This is similar to (<a
     * href="https://hackage.haskell.org/package/base-4.16.2.0/docs/GHC-Base.html#v:sequence">Haskell's
     * sequence function</a>), but specialised for CompletableFutures because we don't have higher
    ...
    /**
     * Transform a collection of {@link CompletableFuture}s into a single {@link CompletableFuture}
    ...
    /**
     * Transform an {@link Iterable} of {@link CompletableFuture}s into a single {@link
