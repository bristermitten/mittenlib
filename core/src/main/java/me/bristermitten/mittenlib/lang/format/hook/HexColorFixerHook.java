 ...
 * color This class tries to parse the §x§a... hex format that {@link net.md_5.bungee.api.ChatColor}
 * uses and turns it into a format that MiniMessage can recognise
 */
