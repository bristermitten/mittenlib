...
/**
 * A MessageFormatter is responsible for formatting a String into a {@link Component}, applying some
 * {@link FormattingHook}s to the String.
 */
public interface MessageFormatter {
    /**
     * Completely format a String into a {@link Component}, applying all {@link FormattingHook}s to
     * the String.
     *
     ...
     * handy when {@link Component}s cannot be used but may leave the String not completely formatted,
     ...
     * String, alongside the existing hooks. This method should always create a new {@link
     * MessageFormatter}, and should not modify the existing one.
     *
