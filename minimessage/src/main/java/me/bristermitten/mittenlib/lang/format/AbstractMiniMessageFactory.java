...
/**
 * A factory for creating {@link MiniMessage instances}. The standard implementation is {@link
 * DefaultMiniMessageFactory}.
 */
public interface AbstractMiniMessageFactory {
    /**
     * Create a {@link MiniMessage} instance for a player. No guarantees are made about when this
     * method will be called. The implementation is not required to use its player argument.
