...
class PrimitiveTypesDeserializationTest extends AnyFunSuite with Matchers {

  test("testPrimitiveTypesDeserialization") {
    ...
    assertCompilation(compilation)
      .generatedSourceFile(
        "me.bristermitten.mittenlib.tests.PrimitiveTypesConfig"
      )
      .isNotNull()
  }
}
