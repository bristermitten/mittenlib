...
class CollectionValidationTest {
    ...
    void testConstraintOnListFailsCompilation() {
        Cute.blackBoxTest().given().processor(ConfigProcessor.class)
                ...
                .andThat()
                .compilerMessage().ofKindError().contains("Constraint annotation @NotBlank cannot be applied to type java.util.List<java.lang.String>. Expected a String or CharSequence.")
                .executeTest();
    }
    ...
    void testConstraintOnMapFailsCompilation() {
        Cute.blackBoxTest().given().processor(ConfigProcessor.class)
                ...
                .thenExpectThat().compilationFails()
                .andThat()
                .compilerMessage().ofKindError().contains("Constraint annotation @Range cannot be applied to type java.util.Map<java.lang.String,java.lang.Integer>. Expected a numeric type.")
                .executeTest();
    }
}
