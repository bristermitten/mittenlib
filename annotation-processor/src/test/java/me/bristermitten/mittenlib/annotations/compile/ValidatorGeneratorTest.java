...
class ValidatorGeneratorTest {
    ...
    @Test
    void testCompilationWithAllValidators() {
        Compilation compilation = javac().withProcessors(new ConfigProcessor())
                .compile(
                        JavaFileObjects.forSourceString("me.bristermitten.mittenlib.tests.MyCustomValidator", """
        ...
        assertThat(compilation).generatedSourceFile("me.bristermitten.mittenlib.tests.ValidatorTestConfigValidator");
    }
}
