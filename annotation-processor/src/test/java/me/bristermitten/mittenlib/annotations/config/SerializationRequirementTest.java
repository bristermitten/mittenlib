...
class SerializationRequirementTest {
    ...
    void testSerializationRequirementFails() {
        Compilation compilation = javac()
                ...
                .compile(JavaFileObjects.forSourceString("me.bristermitten.mittenlib.tests.UnserializableConfigDTO",
                        """
        ...
        assertThat(compilation).hadErrorContaining("Serialization is required for this config, but it contains properties that cannot be serialized");
    }
    ...
    void testSerializationRequirementDefaultsToTrueAndFails() {
        Compilation compilation = javac()
                .withProcessors(new ConfigProcessor())
                .compile(JavaFileObjects.forSourceString("me.bristermitten.mittenlib.tests.UnserializableDefaultConfigDTO",
                        """
                                package me.bristermitten.mittenlib.tests;
    ...
    void testSerializationWarningWhenNotRequired() {
        Compilation compilation = javac()
                .withProcessors(new ConfigProcessor())
                .compile(JavaFileObjects.forSourceString("me.bristermitten.mittenlib.tests.UnserializableWarningConfigDTO",
                        """
                                package me.bristermitten.mittenlib.tests;
