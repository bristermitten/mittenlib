...
public class EqualsHashCodeGenerator {
    ...
    /**
     * Generates an equals method for a configuration class. The generated method follows the standard
     * equals contract: - It's reflexive: an object is equal to itself - It handles null and different
    ...
    public MethodSpec generateEquals(ClassName configClassName, List<Property> properties) {
        ...
        for (Property property : properties) {
            builder.addStatement(
                    "if (!$T.equals(this.$L(), that.$L())) return false",
                    Objects.class,
    ...
    /**
     * Generates a hashCode method for a configuration class. The generated method uses Objects.hash
     * to create a hash code based on all properties, ensuring that objects that are equal according
