...
public class ConfigProcessorModule extends AbstractModule {
    ...
    /**
     * Configures the Guice bindings for this module. Binds the ProcessingEnvironment and its utility
     * classes (Elements and Types) for use by other components in the annotation processor.
     */
    @Override
