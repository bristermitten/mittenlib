...
public sealed interface ASTSettings {
     ...
     * @param generateToString Whether we should generate a {@code toString()} method for the config implementation
     */
     ...
     * @param enumParsingScheme The {@link EnumParsingSchemes} that should be used for this property, if it is an enum.
