 ...
 *
 * <p>As a reference, there are 3 ways of organising data for a config. The first, most simple, is
 * an atomic structure, described by a simple class or interface, eg:
 * <p>
 * {@snippet :
 *
 ...
 * flexible composition. Note that the actual implementation (composition vs inheritance) is left as
 * an implementation detail. Finally, we can create a union of types:
 * <p>
 * {@snippet :
 *
 ...
 * there's nothing to distinguish between the two subtypes aside from their structure. This is not
 * considered a design flaw, but it means there's often no fast way to deserialise aside from trial
 * and error.
 */
@NullMarked
